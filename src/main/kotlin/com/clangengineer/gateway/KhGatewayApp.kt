package com.clangengineer.gateway

import com.clangengineer.gateway.config.ApplicationProperties
import com.clangengineer.gateway.config.CRLFLogConverter
...
class KhGatewayApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes khGateway.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KhGatewayApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KhGatewayApp::class.java)
