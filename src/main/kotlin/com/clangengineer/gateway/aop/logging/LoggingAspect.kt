package com.clangengineer.gateway.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.clangengineer.gateway.repository..*)" +
            " || within(com.clangengineer.gateway.service..*)" +
            " || within(com.clangengineer.gateway.web.rest..*)"
    )
