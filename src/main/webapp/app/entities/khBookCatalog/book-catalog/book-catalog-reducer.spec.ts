...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKCATALOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOOKCATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOOKCATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOOKCATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOOKCATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOOKCATALOG actions', async () => {
      const expectedActions = [
        {
