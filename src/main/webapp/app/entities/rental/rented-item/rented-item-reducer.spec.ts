...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RENTEDITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_RENTEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RENTEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RENTEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RENTEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RENTEDITEM actions', async () => {
      const expectedActions = [
        {
