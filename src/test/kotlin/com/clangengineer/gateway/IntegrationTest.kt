...
import com.clangengineer.gateway.config.AsyncSyncConfiguration
import com.clangengineer.gateway.config.EmbeddedKafka
import com.clangengineer.gateway.config.EmbeddedSQL
...
@SpringBootTest(classes = [KhGatewayApp::class, AsyncSyncConfiguration::class])
@EmbeddedKafka
@EmbeddedSQL
