package com.clangengineer.gateway.config
...
class JHipsterBlockHoundIntegration : BlockHoundIntegration {
    override fun applyTo(builder: BlockHound.Builder) {
        ...
        builder.allowBlockingCallsInside("com.clangengineer.gateway.service.MailService", "sendEmailFromTemplate")
        builder.allowBlockingCallsInside("com.clangengineer.gateway.security.DomainUserDetailsService", "createSpringSecurityUser")
    }
}
